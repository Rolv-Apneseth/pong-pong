...
def game_loop(window, WIDTH, HEIGHT):
    ...
    player1 = Paddle(round(WIDTH*0.05), round(HEIGHT*0.13), round(WIDTH*0.1), round(HEIGHT*0.02))
    player2 = Paddle(round(WIDTH*0.85), round(HEIGHT*0.93), round(WIDTH*0.1), round(HEIGHT*0.02))
    ...
    def redraw_window(window):
        ...
        #Player Score Labels
        player1_score = score_label_font.render(f"Player 1 score: {player1.points}", 1, WHITE)
        window.blit(player1_score, (WIDTH//10, HEIGHT//15))

        player2_score = score_label_font.render(f"Player 2 score: {player2.points}", 1, WHITE)
